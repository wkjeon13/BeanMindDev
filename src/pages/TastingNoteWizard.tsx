...
export default function TastingNoteWizard() {
    ...
    return (
        <div 
            className="h-[100dvh] overflow-hidden flex flex-col bg-black text-white"
            style={{ paddingTop: 'max(env(safe-area-inset-top, 20px), 20px)' }}
        >
            {/* Header */}
            <div className="flex items-center justify-between px-4 py-3 shrink-0 border-b border-zinc-900/50">
            ...
            <div className="flex-1 overflow-y-auto p-4 pb-[30vh] md:pb-8">
